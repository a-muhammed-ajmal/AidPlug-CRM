...
const productTypes = [
    { name: 'Credit Cards', slug: 'credit-cards', icon: CreditCard, productCount: 13 }
];
    ...
    return (
        <div className="space-y-4">
             <div className="bg-white p-4 rounded-xl border shadow-sm">
                ...
                <p className="text-sm text-gray-500 mt-1">Select a product type to see the available options.</p>
            </div>
                    ...
                    >
                        <div className="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">{type.productCount} products</p>
                            </div>
                        </div>
