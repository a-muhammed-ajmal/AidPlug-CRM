    ...
    return (
        ...
        >
            <div className="flex items-start space-x-4">
                <div className={`w-12 h-12 ${colors.bg} ${colors.text} rounded-lg flex items-center justify-center flex-shrink-0`}>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100 grid grid-cols-3 divide-x divide-gray-100 text-center">
                <div>
                    ...
                    <p className="font-bold text-gray-800">{product.total_clients.toLocaleString()}</p>
                </div>
                <div>
                    <p className="text-sm text-gray-500">Value</p>
                    <p className="font-bold text-gray-800">{(product.total_value / 1_000_000).toFixed(1)}M</p>
                </div>
                <div>
                    <p className="text-sm text-gray-500">Growth</p>
                    <p className={`font-bold flex items-center justify-center ${product.growth > 0 ? 'text-green-600' : 'text-red-600'}`}>
