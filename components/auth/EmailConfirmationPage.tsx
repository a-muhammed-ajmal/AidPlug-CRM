  ...
  useEffect(() => {
    ...
    if (!loading) {
      if (user) {
        ...
        setStatus('error');
        setMessage('Email verification failed. The link may be invalid or expired. Please try signing up again.');
      }
    }
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8 text-center">
        ...
        {status === 'success' && (
          <>
            ...
            <h2 className="text-xl font-semibold text-gray-800 text-green-600">Email Verified!</h2>
        ...
        {status === 'error' && (
          <>
            ...
            <h2 className="text-xl font-semibold text-gray-800 text-red-600">Verification Failed</h2>
            <p className="text-gray-600 mt-2">{message}</p>
