...
import { Smartphone, Info, Mail, ChevronRight, HelpCircle, Shield, X } from 'lucide-react';
      ...
      <div className="p-6 space-y-6">
        <div>
          ...
          <div className="space-y-3 text-sm text-gray-600">
            <p>• <strong>Adding Leads:</strong> Go to Leads page and click "Add Lead" button</p>
            <p>• <strong>Managing Clients:</strong> Use the Clients page to view and edit client information</p>
            <p>• <strong>Deal Pipeline:</strong> Track your sales deals in the Deals section</p>
          </div>
        </div>
        <div>
  ...
  <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center p-4">
    <div className="bg-white w-full max-w-2xl rounded-xl shadow-xl max-h-[80vh] overflow-y-auto">
      ...
      <div className="p-6 space-y-4 text-sm text-gray-600">
        ...
        <h3 className="font-semibold text-lg text-gray-900 mt-4">Information We Collect</h3>
        <p>We collect information you provide directly to us, such as when you create an account, use our services, or contact us for support.</p>
        <h3 className="font-semibold text-lg text-gray-900 mt-4">How We Use Your Information</h3>
        <p>We use the information we collect to provide, maintain, and improve our services, process transactions, and communicate with you.</p>
        <h3 className="font-semibold text-lg text-gray-900 mt-4">Data Security</h3>
        <p>We implement appropriate security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.</p>
        <h3 className="font-semibold text-lg text-gray-900 mt-4">Contact Us</h3>
        <p>If you have questions about this Privacy Policy, please contact us at privacy@aidplug.com</p>
      </div>
    </div>
  </div>
);
...
const TermsOfServiceModal = ({ onClose }: { onClose: () => void }) => (
  <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center p-4">
    <div className="bg-white w-full max-w-2xl rounded-xl shadow-xl max-h-[80vh] overflow-y-auto">
      ...
      <div className="p-6 space-y-4 text-sm text-gray-600">
        <p><strong>Effective Date:</strong> October 2024</p>
        <h3 className="font-semibold text-lg text-gray-900 mt-4">Acceptance of Terms</h3>
        <p>By accessing and using AidPlug CRM, you accept and agree to be bound by the terms and provision of this agreement.</p>
        <h3 className="font-semibold text-lg text-gray-900 mt-4">Use License</h3>
        <p>Permission is granted to temporarily use AidPlug CRM for personal and business use, subject to restrictions stated in these terms.</p>
        <h3 className="font-semibold text-lg text-gray-900 mt-4">Disclaimer</h3>
        <p>The materials on AidPlug CRM are provided on an 'as is' basis. AidPlug makes no warranties, expressed or implied, and hereby disclaims all other warranties.</p>
        <h3 className="font-semibold text-lg text-gray-900 mt-4">Limitations</h3>
        <p>In no event shall AidPlug be liable for any damages arising out of the use or inability to use AidPlug CRM.</p>
      </div>
    </div>
  </div>
);
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border shadow-sm">
                ...
                <div className="p-2">
                    <button onClick={() => setShowHelpCenter(true)} className="w-full text-left p-3 hover:bg-gray-50 rounded-lg transition-colors">
                      <SettingsItem icon={HelpCircle} label="Help Center">
                          <ChevronRight className="w-4 h-4 text-gray-400" />
                      </SettingsItem>
                    </button>
                    <button onClick={() => window.location.href = 'mailto:support@aidplug.com'} className="w-full text-left p-3 hover:bg-gray-50 rounded-lg transition-colors">
                      <SettingsItem icon={Mail} label="Contact Support">
                          <ChevronRight className="w-4 h-4 text-gray-400" />
                      </SettingsItem>
                    </button>
                    <button onClick={() => setShowPrivacyPolicy(true)} className="w-full text-left p-3 hover:bg-gray-50 rounded-lg transition-colors">
                      <SettingsItem icon={Shield} label="Privacy Policy">
                          <ChevronRight className="w-4 h-4 text-gray-400" />
                      </SettingsItem>
                    </button>
                    <button onClick={() => setShowTermsOfService(true)} className="w-full text-left p-3 hover:bg-gray-50 rounded-lg transition-colors">
