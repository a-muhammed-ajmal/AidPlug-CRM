...
import { Edit3, User, Upload, CheckCircle, X, KeyRound, LogOut, Eye, EyeOff } from 'lucide-react';
          ...
          {activeTab === 'profile' ? (
            <form onSubmit={handleProfileSubmit}>
              <div className="p-6 space-y-6">
                  ...
                  <div className="flex items-center space-x-6">
                    <div className="relative">
                      ...
                      <button type="button" onClick={() => fileInputRef.current?.click()} className="absolute bottom-0 right-0 w-6 h-6 bg-blue-600 text-white rounded-full flex items-center justify-center shadow">
              ...
              <div className="flex justify-end p-4 border-t bg-gray-50 flex-shrink-0">
                <button type="submit" disabled={isSaving} className="px-6 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 disabled:opacity-50 flex items-center">
              ...
              <div className="border rounded-lg p-4">
                ...
                <form onSubmit={handlePasswordSubmit} className="space-y-4">
                  <div>
                    ...
                    <PasswordStrengthIndicator password={passwordData.password} onValidationChange={setIsPasswordValid} />
                  </div>
                  <div>
                  ...
                  <button 
                    type="submit" 
                    disabled={changingPassword || !isPasswordValid || passwordData.password !== passwordData.confirmPassword} 
