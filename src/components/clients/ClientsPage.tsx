      ...
      <div className="bg-white w-full max-w-2xl rounded-t-2xl sm:rounded-2xl shadow-xl transform transition-transform animate-slide-up flex flex-col max-h-[90vh]">
        ...
        <div className="p-3 flex space-x-2 border-b">
          <button
            ...
            className="flex-1 flex items-center justify-center py-2 px-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm font-semibold disabled:opacity-50"
          >
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center py-2 px-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors text-sm font-semibold disabled:opacity-50"
          >
      ...
      () => {
        deleteClient.mutate(id, {
          onSuccess: () => {
            addNotification(
              'Client Deleted',
              `${clientToDelete.full_name} has been removed.`
            );
            handleCloseModals();
          },
