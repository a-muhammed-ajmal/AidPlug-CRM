...
const ClientCard = React.memo(
  ({ client, onClick, onEdit, onDelete }: ClientCardProps) => {
            ...
            <div className="flex items-start space-x-4 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p
                  ...
                  title={`${client.designation} at ${client.company_name}`}
                >
                  {client.designation} at {client.company_name}
                </p>
                <div className="text-sm text-gray-700 mt-1 flex items-center">
                  <DollarSign className="w-3.5 h-3.5 mr-1 text-gray-400" />
                  <span className="font-medium">
                    AED {client.monthly_salary?.toLocaleString() || 'N/A'}
                  </span>
                </div>
              </div>
            </div>
            <DropdownMenu
              ...
              children={
                <>
                  ...
                  <DropdownMenuItem
                    onClick={(e) =>
                      handleActionClick(e, () => onDelete(client.id))
                    }
